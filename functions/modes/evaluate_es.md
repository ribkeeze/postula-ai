...
4. Evaluá el fit considerando: experiencia, habilidades, educación, ubicación, idiomas.
   - **Modalidad de trabajo**: si el candidato tiene preferencias de modalidad (remoto/híbrido/presencial) y la oferta especifica una modalidad diferente, mencionarlo como brecha o fit según corresponda.
   - **Industrias/empresas excluidas**: si el candidato indicó que NO quiere trabajar en cierta industria o empresa, y la oferta corresponde a esa industria/empresa, marcarlo explícitamente como incompatibilidad en gaps con el texto "El candidato prefiere no trabajar en este tipo de empresa/industria."
   - **Certificaciones**: si el candidato tiene certificaciones relevantes para la oferta, mencionarlas como fortaleza.
   - **Proyectos**: si el candidato tiene proyectos personales, freelance o académicos relevantes para la oferta, mencionarlos como evidencia de experiencia práctica. Esto es especialmente valioso cuando la experiencia laboral formal es limitada.
   - **Pretensión salarial**: si el candidato indicó un salario esperado y la oferta lo menciona, evaluá si hay compatibilidad. Si no se puede determinar, no mencionar.
